...
export class ProjectService {
  ...
  async deleteProject(
    ...
    if (!deltingProject) {
      throw ServiceException.EntityNotFoundException(
        errorMessages.ENTITY_NOT_FOUND('Project', deleteProjectDto.id.toString()),
      );
    }
  ...
  async saveProject(
    ...
    if (!saveProjectDto.saved_by_users.includes(userId)) {
      saveProjectDto.saved_by_users = [...saveProjectDto.saved_by_users, userId];
    }
  ...
  async unsaveProject(
    ...
    unsaveProjectDto.saved_by_users = [...new Set(unsaveProjectDto.saved_by_users)];
  ...
  async createJoinRequest(
    ...
    return this.joinRequestMapper.joinRequestToJoinRequestResponseDto(joinRequest);
  }
  ...
  async handleJoinRequest(
    ...
    if (!project.founder) {
      throw ServiceException.EntityNotFoundException(
        errorMessages.ENTITY_NOT_FOUND('Project Founder', project.founderId.toString()),
      );
    }
    ...
    await this.projectRepository.updateJoinRequestStatus(requestId, projectId, status);
