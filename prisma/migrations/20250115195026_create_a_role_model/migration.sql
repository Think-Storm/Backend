...
-- AlterTable
ALTER TABLE "user_profiles" ADD COLUMN     "role_name" TEXT NOT NULL;
...
-- AddForeignKey
ALTER TABLE "user_profiles" ADD CONSTRAINT "user_profiles_role_name_fkey" FOREIGN KEY ("role_name") REFERENCES "roles"("name") ON DELETE RESTRICT ON UPDATE CASCADE;
