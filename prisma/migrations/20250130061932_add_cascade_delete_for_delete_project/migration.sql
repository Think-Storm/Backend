...
-- DropForeignKey
ALTER TABLE "involvements" DROP CONSTRAINT "involvements_role_name_fkey";
...
-- DropForeignKey
ALTER TABLE "join_requests" DROP CONSTRAINT "join_requests_role_name_fkey";
...
-- AddForeignKey
ALTER TABLE "involvements" ADD CONSTRAINT "involvements_role_name_fkey" FOREIGN KEY ("role_name") REFERENCES "roles"("name") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "join_requests" ADD CONSTRAINT "join_requests_role_name_fkey" FOREIGN KEY ("role_name") REFERENCES "roles"("name") ON DELETE SET NULL ON UPDATE CASCADE;
